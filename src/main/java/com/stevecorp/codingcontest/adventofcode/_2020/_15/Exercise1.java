...
public class Exercise1 {
    ...
    public static void main(final String... args) {
        ...
        System.out.println("The 2020th spoken number is: " + previousInput);

    }

    private static Deque<Long> setupDequeu(final long initialElement) {
        final Deque<Long> deque = new ArrayDeque<>(2);
        deque.addFirst(initialElement);
        return deque;
    }
